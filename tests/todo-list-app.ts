...
describe("todo-list-app", () => {
    ...
    // it("can update a task to done", async () => { // Bu test başarısız oldu. Kontrol et
    //   const task = anchor.web3.Keypair.generate();
    //   // create a new task
    ...
    // it("cannot create a task with more than 400 characters", async () => { // Kontrol et, başarısız oldu
    //   const task = anchor.web3.Keypair.generate();
    //   try {
